...
class WebAppController extends LeftAndMain {

	private static $menu_icon = '/webapp/images/icon.png';
	private static $url_segment = 'webappconfig';
	private static $url_rule = '/$Action/$ID/$OtherID';
	private static $menu_priority = -1;
	private static $menu_title = 'Web App Config';
	private static $tree_class = 'WebAppConfig';
